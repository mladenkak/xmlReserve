...
func (m *CampaignModel) All() ([]models.Campaign, error) {
	// Define variables
	ctx := context.TODO()
	mm := []models.Campaign{}
...
func (m *CampaignModel) FindByID(id string) (*models.Campaign, error) {
...
func (m *CampaignModel) Insert(movie models.Campaign) (*mongo.InsertOneResult, error) {
	return m.C.InsertOne(context.TODO(), movie)
}

// Delete will be used to delete a movie registry
func (m *CampaignModel) Delete(id string) (*mongo.DeleteResult, error) {
	p, err := primitive.ObjectIDFromHex(id)
	if err != nil {
		return nil, err
	}
