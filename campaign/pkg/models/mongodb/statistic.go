...
func (m *StatisticModel) All() ([]models.Statistic, error) {
	// Define variables
	ctx := context.TODO()
	mm := []models.Statistic{}
...
func (m *StatisticModel) FindByID(id string) (*models.Statistic, error) {
...
func (m *StatisticModel) Insert(movie models.Statistic) (*mongo.InsertOneResult, error) {
	return m.C.InsertOne(context.TODO(), movie)
}

// Delete will be used to delete a movie registry
func (m *StatisticModel) Delete(id string) (*mongo.DeleteResult, error) {
	p, err := primitive.ObjectIDFromHex(id)
	if err != nil {
		return nil, err
	}
