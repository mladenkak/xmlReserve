...
func (m *LocationModel) All() ([]models.Location, error) {
	// Define variables
	ctx := context.TODO()
	uu := []models.Location{}
...
func (m *LocationModel) FindByID(id string) (*models.Location, error) {
...
func (m *LocationModel) Insert(user models.Location) (*mongo.InsertOneResult, error) {
	return m.C.InsertOne(context.TODO(), user)
}

// Delete will be used to delete a user
func (m *LocationModel) Delete(id string) (*mongo.DeleteResult, error) {
	p, err := primitive.ObjectIDFromHex(id)
	if err != nil {
		return nil, err
	}
