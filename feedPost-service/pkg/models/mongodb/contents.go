...
func (m *ContentModel) FindByID(id string) (*models.Content, error) {
...
func (m *ContentModel) Insert(user models.Content) (*mongo.InsertOneResult, error) {
